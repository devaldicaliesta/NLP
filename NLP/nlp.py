...
Original file is located at
    https://colab.research.google.com/drive/1EMDE-_ymHVkih6JB10wrr2DIz1qXnXj3
"""
...
#panggil model yang telah diinisiasi pada kode sebelumnya 
model
...
#mendefinisikan variabel untuk kedua kelas tadi
...
#mari kita print hasilnya pada salah satu sampel data, misalnya train_dataset[0].
...
#menguji model pada beberapa contoh kalimat.
text = 'Bahagia hatiku melihat pernikahan putri sulungku yang cantik jelita'
subwords = tokenizer.encode(text)
subwords = torch.LongTensor(subwords).view(1, -1).to(model.device)
